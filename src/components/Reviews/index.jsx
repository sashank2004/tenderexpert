  ...
  return (
    <div className="success-stories-container1">
      <div className="success-stories-container">
        <p className="success-story-heading">Here are some Feedbacks</p>
      ...
      <p className="testimonial-author-text-style2">Yash</p>
      <p className="testimonial-signature1">Mayank Enterprises</p>
    </div>
    </div>
      ...
      <p className="testimonial-author-text-style2">Parveen Kumar</p>
      <p className="testimonial-signature1"></p>
    </div>
    </div>
          </div>
      ...
      <p className="testimonial-author-text-style2">Lalit</p>
      <p className="testimonial-signature1"></p>
    </div>
    </div>
      ...
      <p className="testimonial-author-text-style2">Vijay</p>
      <p className="testimonial-signature1"></p>
    </div>
    </div>
          </div>
